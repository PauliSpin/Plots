...
# Comment out the print statement below and comment the plt.show()
# print(plt.style.available) produces a list of the available style
...
# To actually use the style :

# plt.style.use('fivethirtyeight')
# plt.style.use('ggplot')
plt.xkcd()  # this is actually a method and it will draw the lines 'squiggly' like in a comic
...
# plt.plot(ages_x, dev_y, 'k--', label='All Devs')    # black line (dashes)
# plt.plot(ages_x, dev_y, color='k', linestyle='--',
#         marker = '.', label = 'All Devs')    # much more readable
...
# Have moved the dev_y plot to be the last one as it will overlay the others.
# The plot overlay each other in the order that they are plotted
# so dev_y line would have been hidden by the other plots so plotting it last here
...
# plt.grid(True) # removed the grid as we are using a style

# Automatically adjust plot parameters to include padding
plt.tight_layout()
